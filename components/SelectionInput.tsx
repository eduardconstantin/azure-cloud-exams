  ...
  function SelectionInput(
    ...
    return (
      <>
        ...
        <label
          htmlFor={id}
          className={`m-[1px] flex cursor-pointer items-center rounded-lg border hover:bg-slate-600 hover:border-gray-300 border-slate-500 p-4 text-xs sm:text-sm font-medium shadow-sm ${
